      ...
      <div style={{ width: "460px", flexShrink: 0, background: "linear-gradient(145deg, #7c3aed 0%, #4f46e5 100%)", padding: "3rem", display: "flex", flexDirection: "column", justifyContent: "space-between", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ background: "rgba(255,255,255,0.12)", border: "1px solid rgba(255,255,255,0.15)", borderRadius: "12px", padding: "1.125rem", position: "relative" }}>
          <p style={{ fontSize: "0.875rem", color: "rgba(255,255,255,0.85)", lineHeight: 1.6, marginBottom: "0.75rem" }}>
            &ldquo;From 12% to 89% ATS score. Five interviews in two weeks.&rdquo;
          </p>
          <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
            <div style={{ width: "30px", height: "30px", borderRadius: "50%", background: "rgba(255,255,255,0.2)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "0.65rem", fontWeight: 700, color: "#fff" }}>SC</div>
            <div>
              <div style={{ fontWeight: 600, fontSize: "0.8rem", color: "#fff" }}>Sarah Chen</div>
              <div style={{ fontSize: "0.72rem", color: "rgba(255,255,255,0.6)" }}>Software Engineer at Google</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "2rem 1.5rem" }}>
        ...
        <div style={{ width: "100%", maxWidth: "380px" }}>
          <div style={{ marginBottom: "1.75rem" }}>
            <h1 style={{ fontSize: "1.6rem", fontWeight: 800, letterSpacing: "-0.02em", color: "#0f172a", marginBottom: "0.3rem" }}>Create your account</h1>
            <p style={{ fontSize: "0.875rem", color: "#64748b" }}>3 free scans included — no card required</p>
          </div>
              ...
              {password && (
                <div style={{ marginTop: "0.5rem" }}>
                  <div style={{ display: "flex", gap: "4px", marginBottom: "0.25rem" }}>
                    {[1, 2, 3].map((i) => (
                      <div key={i} style={{ flex: 1, height: "3px", borderRadius: "2px", background: i <= passwordStrength ? strengthColors[passwordStrength] : "#e2e8f0", transition: "background 0.3s" }} />
                    ))}
                  </div>
                  <p style={{ fontSize: "0.72rem", fontWeight: 500, color: strengthColors[passwordStrength] }}>{strengthLabels[passwordStrength]}</p>
                </div>
              )}
            </div>
          ...
          <p style={{ marginTop: "0.75rem", textAlign: "center", fontSize: "0.72rem", color: "#94a3b8" }}>By signing up you agree to our Terms & Privacy Policy</p>
