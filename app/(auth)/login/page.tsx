...
function getAuthErrorMessage(error: string | null): string | null {
  ...
  switch (error) {
    case "OAuthAccountNotLinked":
      return "This email is already registered with a password. Please sign in with email and password instead.";
    case "OAuthSignin":
    case "OAuthCallback":
...
function LoginForm() {
  ...
  return (
    <div style={{ width: "100%", maxWidth: "380px" }}>
      ...
      {authError && (
        <div style={{ display: "flex", alignItems: "flex-start", gap: "0.625rem", padding: "0.75rem 1rem", borderRadius: "8px", background: "#fef2f2", border: "1px solid #fecaca", marginBottom: "1.25rem" }}>
          <span style={{ fontSize: "0.875rem", flexShrink: 0, marginTop: "1px" }}>⚠️</span>
          <p style={{ fontSize: "0.825rem", color: "#b91c1c", lineHeight: 1.5, margin: 0 }}>{authError}</p>
        </div>
      )}
